      ...
      <Link href={"/"} className="group">
        ...
        <div className="py-3 ">
          ...
          <div className="flex gap-1 mt-2">
            <span className="bg-slate-500 text-sm px-2 text-white">CSS</span>
            <span className="bg-slate-500 text-sm px-2 text-white">3D</span>
            <span className="bg-slate-500 text-sm px-2 text-white">GSAP</span>
            <span className="bg-slate-500 text-sm px-2 text-white">
              Three.js
            </span>
            <span className="bg-red-500 text-sm text-white px-1 flex items-center justify-center">
